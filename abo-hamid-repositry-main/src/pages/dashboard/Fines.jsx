...
{/* 
        <div className='bg-yellow-100 text-yellow-900 rounded-xl p-4 flex gap-3'>
          ...
          <div>
            ...
            <p className='text-sm mt-1 leading-6'>
              ...
              The book is still borrowed and overdue. The amount changes with the number of late days and cannot be treated as the final payment yet.
        ...
        {/* <div className='bg-green-100 text-green-900 rounded-xl p-4 flex gap-3'>
          ...
          <div>
            ...
            <p className='text-sm mt-1 leading-6'>
              ...
              The return has already been registered and the backend has stored the final fine amount. This fine can be marked as paid.
